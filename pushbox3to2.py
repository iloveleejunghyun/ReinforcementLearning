...
# start_q_table = "pushbox3to2-1591037344.pickle"  # None or Filename
...
for episode in range(HM_EPISODES):
    player = Blob(1, 1)
    # box_list = [Blob(8, 4), Blob(9, 4), Blob(9, 5), Blob(
    #     8, 6), Blob(8, 7), Blob(8, 8), Blob(8, 9), Blob(10, 9), Blob(11, 7), Blob(12, 7), Blob(12, 8)]
...
with open(f"pushbox3to2-{int(time.time())}.pickle", "wb") as f:
